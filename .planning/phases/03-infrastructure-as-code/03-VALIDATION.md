...
- **After every plan wave:** Run `ansible-playbook --check --diff -i inventory/prod` (Wave 1: tags=common,docker,caddy,ufw; Wave 2: tags=sport-stack; Wave 3: no-tags full) AND smoke probe sequence (Wave 2+)
