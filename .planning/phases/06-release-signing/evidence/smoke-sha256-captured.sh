#!/usr/bin/env bash
# Phase 6 / Plan 06-01 Task 3 — smoke: keystore SHA-256 evidence file consistency
# Verifies VALIDATION row 06-01-03.
#
# Exit codes:
#   0 — smoke green
...
# Wave 0 stub — Task 3 will replace this body with the real probe.
echo "Wave 0 stub — smoke-sha256-captured.sh not yet implemented (see Plan 06-01 Task 3)"
exit 2
