...
// Phase M2: переименован из App. Был root component до Cursona redesign.
// Сохраняется здесь как fallback на случай если новый flow поломается.
// Будет полностью удалён в Phase M12.
